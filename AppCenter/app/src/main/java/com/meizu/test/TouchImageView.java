...
public class TouchImageView extends ImageView{
    ...
    public TouchImageView(TouchActivity activity) {
        super(activity);
        //gintama = BitmapFactory.decodeResource(getResources(), R.drawable.gintama);//获取图片

        DisplayMetrics dm = new DisplayMetrics();
        activity.getWindowManager().getDefaultDisplay().getMetrics(dm);
        widthScreen = dm.widthPixels;
        heightScreen = dm.heightPixels;//获取长宽
    ...
    protected void onDraw(Canvas canvas) {
        canvas.save();
        canvas.drawBitmap(gintama, matrix, null);//绘制
        canvas.restore();
    }
