...
public class MonthCalendarWidget extends AppWidgetProvider {
    ...
    private void drawWidget(Context context, int appWidgetId) {
        ...
        if (widgetOptions != null) {
            int minWidthDp = widgetOptions.getInt(AppWidgetManager.OPTION_APPWIDGET_MIN_WIDTH);//231
            int minHeightDp = widgetOptions.getInt(AppWidgetManager.OPTION_APPWIDGET_MIN_HEIGHT);//236
